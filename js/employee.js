...
// ===================================================================
// 계약서 상세보기 모달 (관리자 페이지에서 가져옴)
// ===================================================================

/**
 * 계약서 상세보기 모달 (관리자 페이지 기능 사용)
...
async function showContractViewModal(contract, currentId, allContracts = []) {
  ...
  // 서명 정보 확인 (localStorage에서)
  const signedContractsStr = localStorage.getItem('signedContracts');
  const signedContracts = signedContractsStr ? JSON.parse(signedContractsStr) : [];
  ...
  modal.innerHTML = `
    <div class="modal-content" style="max-width: 1000px; max-height: 95vh; overflow-y: auto; padding: 0;">
      <!-- 상단 컨트롤 바 -->
      <div style="position: sticky; top: 0; background: white; z-index: 100; padding: 16px; border-bottom: 2px solid #ddd; display: flex; justify-content: space-between; align-items: center;">
      ...
      <!-- A4 계약서 본문 -->
      <div style="width: 190mm; margin: 0 auto; background: white; padding: 40px;">
